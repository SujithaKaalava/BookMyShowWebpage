...
const HomePage=()=>{
    ...
    return(
        ...
        <div className="container mx-auto px-4 md:px-12 my-8">
            ...
            <EntertainmentCardComponente/>
        </div>
        <div className="container mx-auto px-4 md:px-12 my-8">
            
            <PosterSliderComponent title="Recomended Movies" subject="List of recmemnded movies" posters={RecomendedMovies} isDark={false}/>
        </div>
        ...
        <PosterSliderComponent title="premium Movies" subject="brand new releases every friday" posters={premiumMovies} isDark={true}/>
        </div>
         ...
         */}
        <div className="mx-auto px-4 md:px-12 my-8 flex-col gap-3">
        <PosterSliderComponent title="onlinestream events" subject="online stream events" posters={onlinestreamEvents} isDark={false}/>
        </div>
